...
class MyRunnable implements Runnable {
    ...
    private HashMap<Integer, String> triangleMap;
    ...
    public MyRunnable(MutableGraph<Integer> mGraph, HashMap<Integer, String> triangleMap, EndpointPair edge, Iterator nodeItr) {
        this.mGraph = mGraph;
